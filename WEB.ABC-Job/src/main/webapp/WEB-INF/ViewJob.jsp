				...
				<dd:forEach var="showJobs" items="${showJobs}">
					...
					<tr>
						...
						<td><span style="color: blue;"><i
							...
							href="/jobDetails/${showJobs.job_Id}"> View </a></td>
						<td><sf:form action="/deletejob/${showJobs.job_Id}"
								method="get">
								<span style="color: red;"><i
									class='fas fa-times-circle fa-lg fa-fw'></i></span>
								<input
									style="border: none; background-color: trasparent; color: rgb(255, 2, 2);"
